...
subtitle: "<br><br><strong>Jagadish Katam</strong><br>Phuse Wednesday Webinar<br>January 29<br>"
footer: "© 2024 Princeps Technologies All Rights Reserved."
format: 
  revealjs:
    multiplex: true
    preview-links: auto
...
::: {.column width="75%"}
![](img/sankey2.png){fig-align="center"}
...
![](img/sankey_mp4.mp4){fig-align="center"}
...
::: {.column width="75%"}
![](img/sankey1.png){fig-align="right"}
:::
:::
...
::: {.column width="75%"}
![](img/sankey3.png){fig-align="right"}
:::
:::
...
::: {.column width="75%"}
![](img/sankey4.png){fig-align="right"}
:::
:::
...
![](img/label1.png){fig-align="center"}

-   When hovered over a link, the label will display the category of the source node and the category of the target node, followed by the number of subjects transitioning from one category to the next (e.g.,).

![](img/label2.png){fig-align="center"}
...
![](img/Rplot.png){fig-align="center" width="100%" height='100%'}
...
[Slides](https://jagadishkatam.github.io/SankeySlides/sankey.html)
<br/> <br/>
